...
class JudgeWaiting2Component extends React.Component {
    constructor(){
        super();
        this.state = {
        }
                        ...
                        if(this.props.user != _player[0]){
                            ...
                            return(
                                <div className={classes.waitListItem}>
                                    ...
                                    {
                                        _player[1].imgPath ? <CheckCircleOutlineIcon  color='secondary'/>:
...
export default withStyles(styles)(JudgeWaiting2Component);